  ...
  return (
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className={
          'bg-background dark:data-[state=unchecked]:bg-foreground dark:data-[state=checked]:bg-primary-foreground pointer-events-none block size-3 rounded-full ring-0 transition-transform duration-150 ease-[var(--ease-out-quint)] data-[state=checked]:translate-x-[14px] data-[state=unchecked]:translate-x-0'
        }
      />
    </SwitchPrimitive.Root>
  )
